...
<details>
<summary><b>[134] Broadcast-Regular.ttf</b></summary>
<details>
...
* 🔥 **FAIL** Missing required codepoints: 0x0021 (EXCLAMATION MARK), 0x0022 (QUOTATION MARK), 0x0023 (NUMBER SIGN), 0x0024 (DOLLAR SIGN) and 136 more. [code: missing-codepoints]
...
* 🔥 **FAIL** Bad string at [nameID 0, 'utf_16_be']: 'b'Copyright &#169; 2019 by M&#305;chael Chr&#305;stophersson.'' [code: bad-string]
...
"Copyright © 2019 by Mıchael Chrıstophersson." [code: bad-notice-format]
...
* ⚠ **WARN** Font is monospaced but 11 glyphs (14.666666666666666%) have a different width. You should check the widths of: ['i', 'one', 'period', 'comma', 'slash', 'parenleft', 'parenright', 'bracketleft', 'bracketright', 'quotesingle', 'space'] [code: mono-outliers]
...
Glyph name: z	Contours detected: 2	Expected: 1
Glyph name: W	Contours detected: 0	Expected: 1 or 2
Glyph name: eight	Contours detected: 2	Expected: 3 [code: contour-count]
...
* ⚠ **WARN** This seems to be a monospaced font, so advanceWidth value should be the same across all glyphs, but 14.67% of them have a different value: i, one, period, comma, slash, parenleft, parenright, bracketleft, bracketright, quotesingle and space [code: should-be-monospaced]
...
* ℹ **INFO** The family name "Broadcast" seems to be already in use.
...
* ℹ **INFO** This font contains the following optional tables [loca]
...
* 🍞 **PASS** Broadcast-Regular.ttf is named canonically.
